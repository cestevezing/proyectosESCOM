...
SET DEFINE OFF;
Insert into BDS_ESCOM.TBL_MODULO (PK_MOD_IDMODULO,MOD_ULTIMAMODIFICACION,MOD_ESTADO,MOD_ACRONIMO,MOD_DESCRIPCIONMODULO,MOD_NOMBREMODULO,MOD_URL) values ('47',to_date('23/02/20','DD/MM/RR'),'Activo',null,'Modulo encargado de armar el documento maestro','Modulo documental','kk');
Insert into BDS_ESCOM.TBL_MODULO (PK_MOD_IDMODULO,MOD_ULTIMAMODIFICACION,MOD_ESTADO,MOD_ACRONIMO,MOD_DESCRIPCIONMODULO,MOD_NOMBREMODULO,MOD_URL) values ('31',null,'Activo',null,'modulo encargado de la seguridad y acceso a usuarios','Super Administrador','/AdminUsuario');
